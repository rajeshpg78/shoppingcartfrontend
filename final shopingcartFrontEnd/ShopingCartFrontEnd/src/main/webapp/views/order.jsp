						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label for="billingAddress">Billing Address</label><br> 
 								 <input type="text" class="form-control" name="billingAddress" placeholder="Enter billing address" required="true"> 
 							</div> 
							...
							<div class="form-group">
								<label for="shippingAddress">Shipping Address</label><br> <input
									...
									name="shippingAddress" placeholder="Enter shipping address" required="true">
							</div>
							<br>
